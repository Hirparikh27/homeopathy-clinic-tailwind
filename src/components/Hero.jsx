...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative min-h-auto max-w-[1190px] mx-3 sm:mx-4 lg:mx-6 rounded-[24px] sm:rounded-[32px] flex items-center bg-primary overflow-hidden p-[32px_16px] pb-[80px] sm:p-[60px_24px] sm:pb-[100px] md:p-[60px_48px] md:pb-[60px] lg:min-h-[511px] xl:mx-auto lg:rounded-[40px] lg:p-20 lg:px-[72px]"
    >
      ...
      <div className="container relative z-[3] w-full max-w-[1190px] p-0">
        <div className="grid grid-cols-1 items-center gap-8 sm:gap-10 w-full lg:grid-cols-[1fr_365.04px] lg:gap-4 lg:text-left text-center">
          ...
          >
            <div className="bg-[#E8B086] text-[#295C51] p-[6px_14px] min-[414px]:p-[8px_16px] md:p-[10px_20px] rounded-[42.24px] inline-block font-josefin font-semibold text-[13px] min-[414px]:text-[15px] sm:text-[16px] md:text-[20px] leading-none text-center mb-4 sm:mb-6 lg:text-[19.01px] lg:p-[9.63px_22.53px_5.63px_22.53px]">
              Now Open in Ahmedabad
            </div>
            <h1 className="font-cooper text-[24px] min-[414px]:text-[28px] sm:text-[32px] md:text-[40px] lg:text-[48px] font-normal text-white mb-4 sm:mb-6 leading-none">
              Gentle. Natural. Holistic <br />
              Healing with Homeopathy
            </h1>
            <p className="font-josefin text-[14px] min-[414px]:text-[16px] sm:text-[18px] md:text-[22px] lg:text-[22px] text-[#FAF5F0] mb-6 sm:mb-[30px] lg:mb-10 lg:leading-none font-normal">
