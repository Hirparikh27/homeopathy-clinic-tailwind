...
const Homeopathy = () => {
  ...
  return (
    <section id="homeopathy" className="pt-16 pb-20 bg-white md:pb-16">
      <div className="max-w-[1190px] mx-auto px-4 md:px-14 xl:px-0">
        <div className="bg-[#F8F8F8] rounded-[24px] p-8 relative overflow-hidden xl:p-[56px] md:p-14 sm:p-10">
          <div className="flex flex-col xl:flex-row items-center gap-8 xl:gap-[88px]">
            {/* Content Side */}
            <div className="flex-1 text-center xl:text-left">
              <h2 className="font-cooper text-[32px] md:text-[44px] font-normal leading-[1.2] text-[#1A1A1A] mb-4 md:mb-6">
                What is Homeopathy?
              </h2>
              <p className="font-josefin text-[16px] md:text-[21px] font-normal leading-[1.4] text-[#666666] mb-8 md:mb-10 max-w-[600px] mx-auto xl:mx-0">
                Homeopathy is a natural system of medicine that stimulates the
                body's self-healing ability using highly diluted remedies.
              </p>

              {/* Badges Grid */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4 w-full sm:w-fit mx-auto xl:mx-0">
